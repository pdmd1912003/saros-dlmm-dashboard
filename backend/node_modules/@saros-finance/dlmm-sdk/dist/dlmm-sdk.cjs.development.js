      ...
      return _regenerator().w(function (_context10) {
        while (1) switch (_context10.n) {
          ...
          case 11:
            ...
            if (!!pairInfo.hook) {
              hookBinArrayLower = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pairInfo.hook.toBuffer(), new anchor.BN(binArrayLowerIndex).toArrayLike(buffer.Buffer, "le", 4)], this.hooksProgram.programId)[0];
              hookBinArrayUpper = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pairInfo.hook.toBuffer(), new anchor.BN(binArrayUpperIndex).toArrayLike(buffer.Buffer, "le", 4)], this.hooksProgram.programId)[0];
              remainingAccounts = [{
                pubkey: hookBinArrayLower,
                isWritable: true,
                isSigner: false
  ...
  return _createClass(LiquidityBookServices, [{
    ...
    get: function get() {
      if (this.mode === exports.MODE.DEVNET) {
        return new web3_js.PublicKey("BJG6uz2zY2XFG7uomiyi17qqDeYJUnbprGbpyzYN1ncU");
      }
    ...
    get: function get() {
      if (this.mode === exports.MODE.DEVNET) {
        return new web3_js.PublicKey("GN3UN8CtcSvC1VZxgHwfKqXXi642EwNk5K19FupZGMrZ");
      }
